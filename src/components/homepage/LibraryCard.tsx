  ...
  {muscleGroups.map((group) => (
    ...
    >
      ...
      <div className="flex gap-3 text-[#9CA3AF] pt-1">
        <span><i className="fa-regular fa-clock"></i> {duration} min</span>
  <span><i className="fa-solid fa-fire "></i> {caloriesBurned} kcal</span>
  <span><i className="fa-regular fa-star "></i> {rating}</span>
      </div>
